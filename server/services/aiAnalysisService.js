...
export class AIAnalysisService {
  ...
  buildAnalysisPrompt() {
    ...
    if (features.depict) {
      prompt += '- depict: A poetic and evocative description in Chinese (重点是用一句话(10字左右)点出图片的特别之处，简短有力，勾起欣赏者的回忆。1.可以是画面细节意境描述，用简洁优美的语言描绘画面氛围和情感；2.可结合贴合画面的诗词；3.如果知道是哪里也可以直接说是哪里的什么，或者是形容这里的诗句。无论是哪种描述方法，切记要简短，简单易懂，信达雅)\n';
    }
    if (features.quality) {
